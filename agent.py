...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        self.qnetwork_local = DQN(3, action_size, seed=20, fc1_units=64, fc2_units=64).to(device)
        self.qnetwork_target = DQN(3, action_size, seed=20, fc1_units=64, fc2_units=64).to(device)
